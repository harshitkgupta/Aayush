...
<html>
    <head>
       ...
       <table align="center" width="600" height="630" border="0" background="plusbgpro.jpg">
           ...
           <tr>
               <td>Email Id :</td>
               <td align="center"><input type="text" name="email" size="30" disabled value="<%=rs.getString(7)%>"></td>
           </tr>
           <tr>
               <td>Mobile No :</td>
               <td align="center"><input type="text" name="mobile" size="30" disabled value="<%=rs.getString(8)%>"></td>
           </tr>
           <tr>
               <td>Country :</td>
               <td align="center"><input type="text" name="country" size="30" disabled value="<%=rs.getString(9)%>"></td>
           </tr><%}%>
       </table>
        </form>
    </body>
